...
['Deployed a Flask REST API on Heroku to receive image and user data from the front end','Used Google Vision API to extract key fashion features from the user','Built a MySQL database deployed on AWS of various clothing items and related features (eg. ID, purchase link, company)','Returned a list of recommendations to the frontend','Check out the project at www.fabrical.me'],"https://github.com/yifei-tang","https://www.youtube.com/embed/d3qbEo4aYDA",'pro-6',"");
